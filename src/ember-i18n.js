(function(window) {
    ...
    Handlebars.registerHelper('t', function(key, options) {
        ...
        Em.keys(attrs).forEach(function(property) {
            ...
            //[sebastianseilund] Begin nice property fix
            if (options.hashTypes[property] === 'ID') {
                attrs[property + 'Binding'] = attrs[property];
                options.hashTypes[property + 'Binding'] = 'STRING';
                delete attrs[property];
                delete options.hashTypes[property];
                property += 'Binding';
            }
